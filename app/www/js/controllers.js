...
.controller('FirstRunCtrl', ['$scope', '$state', '$cordovaSQLite', function($scope, $state, $cordovaSQLite){
	
}])

.controller('FirstPrefCtrl', ['$scope', 'Preferences', function($scope, Preferences){
	$scope.categories = Preferences.items;
}])
